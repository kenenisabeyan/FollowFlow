    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage your customer relationships and record follow-up status.</p>
        </div>
      ...
      <div className="glass rounded-2xl border border-white/5 overflow-hidden">
        <div className="overflow-x-auto min-h-[300px]">
          {loading ? (
            <div className="flex justify-center items-center h-48 text-primary-400">Loading customers...</div>
          ) : (
              ...
              <tbody className="divide-y divide-white/5">
                {filteredCustomers.map((customer) => (
                  <tr key={customer.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-gray-300 font-medium">{customer.company_name}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full bg-surfaceLighter border border-white/10 rounded-lg p-2.5 text-sm text-gray-200 focus:border-primary-500 outline-none"
